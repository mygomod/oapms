...
func NewGormAdapter() *GormAdapter {
	a := &GormAdapter{mus.Db}
	// Call the destructor when the object is released.
	runtime.SetFinalizer(a, finalizer)
	return a
}

func loadPolicyLine(line mysqlModel.CasbinRule, model model.Model) {
	lineText := line.P
	if line.V0 != "" {
		lineText += ", " + line.V0
	}
...
func (a *GormAdapter) LoadPolicy(model model.Model) error {
	var lines []mysqlModel.CasbinRule
	a.o.Find(&lines)
...
func savePolicyLine(ptype string, rule []string) mysqlModel.CasbinRule {
	line := mysqlModel.CasbinRule{}
...
func (a *GormAdapter) RemovePolicy(sec string, ptype string, rule []string) error {
	...
	do := a.o.Delete(mysqlModel.CasbinRule{}, "p=? and v0=? and v1=? and v2=? and v3=? and v4=? and v5=?", line.P,
		line.V0,
		line.V1,
		line.V2,
		line.V3,
...
func (a *GormAdapter) RemoveFilteredPolicy(sec string, ptype string, fieldIndex int, fieldValues ...string) error {
	...
	//	line.V4,
	//	line.V5)
	do := a.o.Delete(mysqlModel.CasbinRule{}, params...)
	return do.Error
}
